...
public class AEOTPTextField: UITextField {
    ...
    public var otpDefaultBorderColor: UIColor = UIColor(red: 0.82, green: 0.82, blue: 0.82, alpha: 1)
    /// The border color of the text field slots after entering a character
    public var otpFilledBorderColor: UIColor = UIColor(red: 0.82, green: 0.82, blue: 0.82, alpha: 1)
